...
* [What is an Operating System](#what-is-an-operation-system)
    * [Why Linux](#why-linux)
    * [Who Uses Linux](#who-uses-linux)
* [History](#history)
    * [Birth of C](#birth-of-c)
    * [Birth of Unix](#birth-of-unix)
...
* [Basic Linux Commands](#basic-linux-commands)
    ...
    | [nano](#nano)| [vi / vim](#vi--vim) | [cat](#cat) | [cp](#cp) | [mv](#mv) |
    | [rmdir](#rmdir) | [rm](#rm) | [link](#hardlink-and-softlink) | [chmod](#chmod) |  |
...
![UnixFeatures](images/UNIXFeatures.drawio.svg)
